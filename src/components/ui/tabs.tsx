...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-[#232731] p-1 text-gray-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-[#4CAF50] data-[state=active]:text-white data-[state=active]:shadow",
      "hover:bg-[#2A2F3A] hover:text-white",
      className
    )}
    {...props}
  />
